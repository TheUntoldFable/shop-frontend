...
export default function WishlistItem(props) {
  ...
  const discount = getDiscountedPricePercentage(
    props.wishlistItem.original_price,
    props.wishlistItem.price
  )

  const imageSrc = props.wishlistItem.thumbnail.url
  ...
  return (
    ...
    >
      <div>
        <Link
          href={{ pathname: `/product/${props.wishlistItem.slug}` }}
      ...
      <div className="p-4 text-offWhite/[0.9]">
        ...
        <div className="flex items-center text-black/[0.5]">
          <p className="mr-2 text-lg font-semibold">
            {props.wishlistItem.price} {currency}.
          </p>
              ...
              {discount > 0 && (
                <>
                  <p className="text-offWhite text-base  font-medium line-through">
                    {props.wishlistItem.original_price} лв.
                  </p>
